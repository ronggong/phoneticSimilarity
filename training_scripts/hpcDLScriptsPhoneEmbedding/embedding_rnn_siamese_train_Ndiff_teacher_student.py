...
if __name__ == '__main__':
    ...
    for ii in range(0, 5):
        if output_shape == 2:
            model_name = 'phone_embedding_RNN_triplet_Ndiff5_teacher_student_margin_2_class_cpu'+margin
        else:
            model_name = 'phone_embedding_RNN_triplet_Ndiff5_teacher_student_margin_cpu'+margin
