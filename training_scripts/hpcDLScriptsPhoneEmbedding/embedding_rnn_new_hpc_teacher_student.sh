...
# Output/Error Text
# ----------------
#SBATCH -o /homedtic/rgong/phoneEmbeddingModelsTraining/out/emb_rnn_ts_2_class_conv.%N.%J.%u.out # STDOUT
#SBATCH -e /homedtic/rgong/phoneEmbeddingModelsTraining/out/emb_rnn_ts_2_class_conv.%N.%J.%u.err # STDERR
