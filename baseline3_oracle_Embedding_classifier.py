...
from phonetic_assessment import measureEmbDissimilarity
...
def runProcess(val_test, plot):
    ...
    scaler = pickle.load(open(kerasScaler_emb_cla_path, 'rb'), encoding='latin1')
    ...
    for artist, fn in recordings:
        ...
        for ii_line in range(len(studentPhonemeLists)): # iterate each line
            ...
            for ii_phn in range(len(list_phn_student_pair)):
                ...
                # calculate GOP
                cos_dis_phn = measureEmbDissimilarity(model_keras_cnn_0=model_keras_cnn_0,
